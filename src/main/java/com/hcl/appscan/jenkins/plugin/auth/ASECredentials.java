...
public class ASECredentials extends UsernamePasswordCredentialsImpl{
	...
	public ASECredentials(String id, String description, String username, String password, String url) throws FormException {
		this(CredentialsScope.GLOBAL, id, description, username, password);
		m_url=url;
	}
	
	public ASECredentials(CredentialsScope scope, String id, String description, String username, String password) throws FormException {
	...
	public static final class DescriptorImpl extends CredentialsDescriptor {
		...
		public String getApiDocUrl() {
			return "https://help.hcl-software.com/appscan/Enterprise/9.0.3/topics/t_appscan_enterprise_rest_APIs_list.html";
		}
